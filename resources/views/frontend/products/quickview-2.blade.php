...
<body class="extension-soconfig-quickview-74 ltr res layout-1  ">
                        ...
                        <div class="content-product-left class-honizol  col-sm-5">
                            ...
                            <div class="large-image ">
                                ...
                                <div id="thumb-slider" class="owl-theme owl-loaded owl-drag full_slider ">
                                    <a data-index="0" class="img thumbnail" title="Nome do Produto">
                                        <img src="{{url('assets/frontend/images/products/700x700/produto8-cor1.jpg')}}" title="Nome do Produto" alt="Nome do Produto" />
                                    </a>
                                    <a data-index="1" class="img thumbnail" title="Nome do Produto">
                                        <img src="{{url('assets/frontend/images/products/700x700/produto8-cor2.jpg')}}" title="Nome do Produto" alt="Nome do Produto" />
                                    </a>
                                    <a data-index="2" class="img thumbnail" title="Nome do Produto">
                                        <img src="{{url('assets/frontend/images/products/700x700/produto8-cor3.jpg')}}" title="Nome do Produto" alt="Nome do Produto" />
                                    </a>                                   
                                </div>
                                <script type="text/javascript">
                                    <!--
                                    jQuery(function($) {
                                        var thumbWidth = $(".large-image img").width() + 2,
                                            thumbHeight = $("#thumb-slider .img").height();
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    ...
                                    <div class="product_page_price price" itemprop="offerDetails" itemscope itemtype="http://data-vocabulary.org/Offer">
                                        <span class="price-new"><span itemprop="price" id="price-special">$60.00</span></span> <span class="price-old" id="price-old">$71.00</span>
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="product-box-desc">
                                        <div class="model"><span>Product Code:</span> e26</div>

                                        <div class="stock"><span> Stock </span> <i class="fa fa-check-square-o"></i> 478</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="box-checkbox form-group required">
                                    ...
                                    <div id="input-option233">
                                        <div class="checkbox  radio-type-button">
                                            <label>
                                            <input type="checkbox" name="option[233][]" value="34" />
                                            <span class="option-content-box" data-title="+$5.00" data-toggle='tooltip'>
                                        ...
                                        <div class="checkbox  radio-type-button">
                                            ...
                                            <span class="option-content-box" data-title="+$10.00" data-toggle='tooltip'>
                                                                                                <span class="option-name">violet</span>
                                                                                            </span>
                                        </label>
                                        </div>
                                        <div class="checkbox  radio-type-button">
                                            <label>
                                            <input type="checkbox" name="option[233][]" value="31" />
                                            <span class="option-content-box" data-title="+$10.00" data-toggle='tooltip'>
                                        ...
                                        <div class="checkbox  radio-type-button">
                                            <label>
                                            <input type="checkbox" name="option[233][]" value="32" />
                                            <span class="option-content-box" data-title="+$10.00" data-toggle='tooltip'>
                                        ...
                                        <div class="checkbox  radio-type-button">
                                            <label>
                                            <input type="checkbox" name="option[233][]" value="33" />
                                            <span class="option-content-box" data-title="+$10.00" data-toggle='tooltip'>
                            ...
                            <div class="form-group box-info-product">
                                ...
                                <div class="detail-action">
                                    ...
                                    <div class="add-to-links wish_comp">
                                        <ul class="blank">
                                            <li class="wishlist">
                                                <a class="icon" data-toggle="tooltip" title="Add to Wish List" onclick="wishlist.add('74');"><i class="fa fa-heart"></i></a>
                                            </li>
                                            <li class="compare">
                                                <a class="icon" data-toggle="tooltip" title="Compare this Product" onclick="compare.add('74');"><i class="fa fa-refresh"></i></a>
                                            </li>
                                            <li class="detail">
                                                <a href="http://opencart.opencartworks.com/themes/so_etrostores/index.php?route=product/product&amp;product_id=74" data-toggle="tooltip" title="Detail" target="_top" class="icon"><i class="fa fa-chevron-right"></i> </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
