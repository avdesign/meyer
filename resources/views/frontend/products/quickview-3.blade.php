                            ...
                            <div class="large-image ">
                                ...
                                <div id="thumb-slider" class="owl-theme owl-loaded owl-drag full_slider ">
                                    <a data-index="0" class="img thumbnail" title="Nome do Produto">
                                        <img id="img-3" src="{{url('assets/frontend/images/products/700x700/produto1-cor3.jpg')}}" title="Nome do Produto" alt="Nome do Produto" />
                                    </a>
                                    <a id="img-2" data-index="1" class="img thumbnail" title="Nome do Produto">
                                        <img src="{{url('assets/frontend/images/products/700x700/produto1-cor2.jpg')}}" title="Nome do Produto" alt="Nome do Produto" />
                                    </a>
                                    <a id="img-1" data-index="2" class="img thumbnail" title="Nome do Produto">
                                        <img src="{{url('assets/frontend/images/products/700x700/produto1-cor1.jpg')}}" title="Nome do Produto" alt="Nome do Produto" />
                                    </a>                                   
                                </div>
                        ...
                        <div class="content-product-right col-sm-7">
                            ...
                            <div class="row">
                                <div class="col-sm-5 col-xs-12">
                                    ...
                                    <div class="box-review">
                                        ...
                                        -->
                                        <span class="reviews_button">0 comentário</span>
                                    </div>
                                ...
                                <div class="col-sm-7 col-xs-12">
                                    <div class="product-box-desc">
                                        ...
                                        <div id="new_stock" class="stock"><span> Estoque: </span> <i class="fa fa-check-square-o"></i> 18 caixas</div>
                                        <div id="new_grade" class="model">
                                            <span>Grade: 2/35 2/36 3/37 2/38 2/39</span> 
                                        </div>                                        
                                    </div>                                  
                            ...
                            <div class="form-group box-info-product">
                                ...
                                <div class="detail-action">
                                    <div class="cart">
                                        <input type="button" data-toggle="tooltip" title="Adicionar" value="Adicionar" data-loading-text="Aduarde..." id="button-cart" class="btn btn-mega btn-lg " />
                                    </div>
                                    ...
                                    <div class="add-to-links wish_comp">
                                        <ul class="blank">
                                            <!--
                                            <li class="wishlist">
                                                <a class="icon" data-toggle="tooltip" title="Desejo" onclick="wishlist.add('74');"><i class="fa fa-heart"></i></a>
                                            </li>
                                            <li class="compare">
                                                <a class="icon" data-toggle="tooltip" title="Compare" onclick="compare.add('74');"><i class="fa fa-refresh"></i></a>
                                            </li>
                                            -->
                                            <li class="detail">
                                                <a href="{{url('produto/detalhes/3')}}" data-toggle="tooltip" title="Detalhes" target="_top" class="icon"><i class="fa fa-chevron-right"></i> </a>
                                            </li>
                                        </ul>
                                    </div>
