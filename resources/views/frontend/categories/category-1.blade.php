...
@push('css')
    <link rel="stylesheet" href="{{url('assets/frontend/js/avd_filter_shop_by/css/nouislider.css')}}">
    <link rel="stylesheet" href="{{url('assets/frontend/js/avd_filter_shop_by/css/style.css')}}">
...
@endpush
@push('scripts')
    <script src="{{url('assets/frontend/js/avd_filter_shop_by/js/nouislider.js')}}"></script>
...
@section('content')
    ...
    <div class="container product-listing content-main">
        <div class="row">
            ...
            @include('frontend.categories.filters.filter-1')

            <div id="content" class="col-md-9 col-sm-12 col-xs-12">
                <a href="javascript:void(0)" class="open-sidebar hidden-lg hidden-md"><i class="fa fa-bars"></i>Veja Mais</a>
                <div class="sidebar-overlay "></div>
                <div class="products-category">

                    @include('frontend.sliders.category-1')
