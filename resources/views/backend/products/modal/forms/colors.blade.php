...
<div class="fieldset silver-bg">
    <p class="block-label button-height">
        ...
        <input type="text" name="img[code]" id="code_img_{{$idpro}}" value="{{$data->code or old('code')}}" class="input full-width">
    </p>
    <p class="block-label button-height">
        <label for="color_img_{{$idpro}}" class="label">Cor<span class="red">*</span></label>
        <input type="text" name="img[color]" id="color_img_{{$idpro}}" value="{{$data->color or old('color')}}" class="input full-width">
    </p>
    <p class="block-label button-height">
        <label for="description_img_{{$idpro}}" class="label">Descrição</label>
        <textarea name="img[description]" id="description_img_{{$idpro}}"  class="input full-width description_img" cols="10" rows="2">{{$data->description or old('description')}}</textarea>
    </p>
    ...
    <p class="button-height inline-small-label">
        ...
        <span class="number input margin-right">
            ...
            <input type="text" name="img[order]" value="{{$data->order or old('order')}}" size="2" class="input-unstyled">
