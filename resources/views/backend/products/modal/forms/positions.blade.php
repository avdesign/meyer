				...
				<fieldset class="fieldset">
					...
					<p class="button-height inline-small-label">
						...
						<span class="number input margin-right">
							...
							<input type="text" name="pos[order]" value="{{$data->order or old('order')}}" size="2" class="input-unstyled">
			...
			<div class="seven-columns twelve-columns-tablet">
				...
				<fieldset class="fieldset">
					<p class="button-height  block-label"> 
						<input type="file" name="file" id="upload_position" value="" class="file" onchange="preview_image('upload_position', 'preview_position', 350);"/>
					</p>
