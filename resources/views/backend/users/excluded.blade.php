...
<script src="{!! url('assets/backend/scripts/users-excluded.js') !!}"></script>
<script>
    var avdTable = {!! json_encode([
        "id" => 'excluded',
        "url_excluded" => route('users.excluded.data'),
        "url_reactivate" => route('user.reactivate'),
...
<div id="excluded_@{{{id}}}" class="content-panel margin-bottom">
    <div class="panel-navigation silver-gradient">
        <div class="panel-control">
            <button id="btn-reactivate" onclick="reactivateExcluded('@{{{id}}}', '@{{{name}}}')" class="button blue-gradient with-tooltip" title="Reativar Usuário">
