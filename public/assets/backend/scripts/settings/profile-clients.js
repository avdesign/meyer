...
;(function($)
{   
    $.fn.loadTableProfileClients = function()
    {
        var table = $('#'+avdTable.id).DataTable({
            ...
            columns: [
                ...
                {data: 'profile'},
                {data: 'percent_card', className: 'align-center'},
                {data: 'percent_cash', className: 'align-center'},
                {data: 'sum', className: 'align-center'},
        ...
        */
        deleteProfileClient = function(url, name)
        {
