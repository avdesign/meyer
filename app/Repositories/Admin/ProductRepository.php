...
class ProductRepository implements ProductInterface
{
    ...
    public function create($input)
    {
        ...
        if ($input['tags'] == '') {
            $input['tags']  = "{$product}, {$category}, {$section}, {$brand}, ".str_slug($keywords['title']);
        }
        if ($input['description'] == '') {
            $input['description']  = $keywords['description'].", {$product}, {$category}, {$section}, {$brand}";
        }
        ...
        if ($data) {
            ...
            if ($update) {
                ...
                ($data->offer == 1 ? $offer = ", Oferta:Ativo"  : $offer = "");
    ...
    public function update($input, $data, $id)
    {
        ...
        ($data->offer == 1 ? $current_offer = ", Oferta:Ativo"  : $current_offer = "");
