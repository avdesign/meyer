...
use AVDPainel\Interfaces\Admin\ConfigPriceInterface as InterModel;
...
class ConfigPriceController extends AdminAjaxTablesController
{
    
    protected $ability = 'config-price';
    protected $view    = 'backend.config.prices';
    protected $last_url;
    protected $messages;
