...
class LoginController extends Controller
{
    ...
    */
    ...
    protected $redirectTo = 'painel/admin';
    protected $access;
    ...
    public function login(Request $request)
    {
        ...
        if ($ajax == 1){
            ...
            if ( auth()->guard('admin')->attempt($credenciais, $remember) ) {
                ...
                return response()
                    ->json(['logged' => true, 'redirect' => url('painel/admin#'.$ac->last_url)])
                    ->withCallback($request->input('callback'));

            }
            // Crair um cache com IP do usuário que faz as tentativas.
            ...
            // Se usuário superar seu número máximo de tentativas.
    ...
    /**
     * Obtenha a instância de resposta de login com falha.
     *
